...
web:
	emcc -o index.html ./src/main.cpp -Os -Wall $(libraylib_web) -I. -I$(raylib_h) -L. -L$(libraylib_web) -s USE_GLFW=3 -s ALLOW_MEMORY_GROWTH --shell-file $(raylib_shell) -DPLATFORM_WEB
